      ...
      <footer className="bg-charcoal text-white py-12 relative overflow-hidden">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-300 mb-4">
                Where collaborative intelligence meets business reality. Connected AI implementation for measurable results.
              </p>
          ...
          <div className="border-t border-hive-gold/30 mt-8 pt-8 text-center text-gray-300">
            <p>&copy; 2025 Hive Studio AI. All rights reserved. Built with connected intelligence.</p>
          </div>
        </div>
      </footer>
